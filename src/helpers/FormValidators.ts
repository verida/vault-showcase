    ...
    if (
      ...
      schemaObject = {
        ...
        [prop]: yup
          ...
          .max(
            today,
            `Date of Birth field must be at an earlier date than "${today.toLocaleDateString()}"`
          )
          .required(),
      };
      ...
      schemaObject = {
        ...
        [prop]: yup
          .string()
          .matches(phoneRegExp, "Phone number is not valid (e.g +234 081xxxx)")
      ...
      schemaObject = {
        ...
        [prop]: yup
          .string()
          .min(58, "DID length not valid")
          .max(58, "DID length not valid"),
      };
